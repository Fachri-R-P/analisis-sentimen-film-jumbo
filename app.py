...
naive_bayes_model = pickle.load(open('model_nb.pkl', 'rb'))  # sesuaikan nama file jika beda
tfidf = pickle.load(open('vectorizer.pkl', 'rb'))  # sesuaikan nama file jika beda
...
if st.button("🔍 Analisis"):
    if user_input.strip() == "":
        ...
        prediction = naive_bayes_model.predict(vectorized)
